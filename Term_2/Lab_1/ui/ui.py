...
class Ui:
    ...
    def _draw_field(self):
        ...
        for animal in self.field.livings:
            cell = self.table.get_cell(self.field.livings[animal][0]+1, self.field.livings[animal][1]+1)
        ...
        for plant in self.field.plants:
            cell = self.table.get_cell(self.field.plants[plant][0]+1, self.field.plants[plant][1]+1)
