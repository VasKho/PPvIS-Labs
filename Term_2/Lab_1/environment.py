...
class Animal(ABC, Food):
    ...
    def __init__(self, health: int, age: int, lifespan: int, energy_value: int, for_herbivorous: bool, hunger: int = 100) -> None:
        self.health = health
        self.age = age
...
class Area:
    ...
    def __init__(self, size: tuple[int, int], livings: dict = dict(), plants: dict = dict()) -> None:
        self.area = size
